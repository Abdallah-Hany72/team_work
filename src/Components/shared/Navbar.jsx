...
export default function Navbar() {
  ...
  return (
    <nav className="w-full h-16 border-b border-outline-variant/30 bg-surface-container-lowest sticky top-0 z-50 px-6 md:px-16 flex items-center justify-between">
      {/* Brand Logo & Search Area */}
      <div className="flex items-center gap-6 flex-1 max-w-xl">
        <Link to="/" className="font-display-lg text-headline-lg font-bold text-primary tracking-tight">
          Spotly
        </Link>
        
        {/* Contextual Search Input (only displayed when not on the landing page) */}
        {!isHome && (
